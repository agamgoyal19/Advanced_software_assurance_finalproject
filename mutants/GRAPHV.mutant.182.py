...
from node_g import Node
from edge_g import Edge
...
#  The primary methods you call to use this visualizer
    ...
    def plot(self):
        ...
        plt.plot([x.x for x in self.nodes], 'ko', [x.y for x in self.nodes],
...
if __name__ == "__main__":
    x=GRAPHV()  # make yourself a new visualizer
    x.loadGraphFromFile('input.txt')  # load it up from a map file
